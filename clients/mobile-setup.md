...
3. Base URL: `https://your-reserved-domain.ngrok-free.app/v1`
...
2. API Base URL: `https://your-reserved-domain.ngrok-free.app/v1`
...
- Because the domain is reserved and the token lives in a Colab secret, both stay the same across restarts -- you configure each client once.
